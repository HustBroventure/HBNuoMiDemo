...
- (void)showLeft
{
    ...
    [self doTheAnimate:_proportion type:0];
...
- (void)doTheAnimate:(CGFloat)proportion type:(NSInteger)showWhat
{
...
- (BOOL)gestureRecognizer:(UIGestureRecognizer *)gestureRecognizer shouldReceiveTouch:(UITouch *)touch
{
    if ( [gestureRecognizer isKindOfClass:[UIPanGestureRecognizer class]]) {
        ...
        if (point.x > 20 && self.mainView.center.x == self.view.center.x) {
            return NO;
        } else {
